...
{
    public partial class ViewPastSales : System.Web.UI.Page
    {
        ...
        private void BindGridViewData()
        {
            ...
            else
            {
                ...
                string sqlcommand1 = "SELECT [Picture_data] AS [ImgDir], [Product_name] AS [ItemName], [Buyer_username] AS [BuyerUsername],[Price] AS [Price] FROM [PURCHASE] WHERE [Seller_username] = @Username";
                ...
                else
                {
                    ...
                    lblMessage2.Text = "You have no sales";
                }
                dbConn.Close();
        ...
        protected void btnRate_Click(object sender, EventArgs e)
        {
            ...
            string sellerUsername = ((Label)clickedRow.FindControl("productBuyer")).Text;

            // Store the data in Session variables
            Session["ProductName"] = productName;
            Session["BuyerUsername"] = sellerUsername;

            // Redirect to the "RateTheSeller.aspx" page
            Response.Redirect("~/Admin/RateTheBuyer.aspx");
        }
    }
}