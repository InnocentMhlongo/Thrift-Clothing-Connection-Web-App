<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/LogSign.Master" AutoEventWireup="true" CodeBehind="ViewPurchases.aspx.cs" Inherits="Thr_fty.Admin.ViewPurchases" EnableEventValidation="false" %>
    ...
    <div id="signUp">
         <div id="signUpForm" class="Relative"  >
            ...
            <h1>Your Purchases</h1>
             <asp:Label ID="lblMessage2" runat="server" Text="" Font-Size="Large" Font-Bold="true" ></asp:Label>
             <br />
        ...
        <div id="cartContainer">
            ...
            <tr>
               ...
               <td style="text-align: center; width: 100px;">Price</td>
                <td style="text-align: center; width: 100px;">Seller's Name</td>
        ...
        <ItemTemplate>
           <div id="cartContainer">
               ...
               <asp:Label ID="productPrice" runat="server" Text='<%# Eval("Price","R{0}")%>' Width="100px" ></asp:Label>
                ...
                <asp:Label ID="productSeller" runat="server" Text='<%# Eval("SellerUsername")%>' Width="100px" ></asp:Label>
            ...
            <asp:GridView ID="GridView1" runat="server"  AutoGenerateColumns="False" BorderStyle="None" GridLines="None" CssClass="CenterText Shadow margin-cell Chin Width75" CellSpacing="10" ShowHeader="False">
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Label ID="productSeller" runat="server" Text='<%# Eval("SellerUsername")%>' CssClass="MakeOrange MakeBold"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                         <asp:TemplateField>
                            <ItemTemplate>
